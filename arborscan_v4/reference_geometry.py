...
def reference_geometry(ref):
    ...
    if lines['trunk']:
        ...
        level=projection([ref['tree'][0],mid])
    ...
    return {
      ...
      'trunk_measurement_height':metric(level,'m','marked section midpoint above marked tree base in projection; not forestry DBH rule','Mark stem edges'),
